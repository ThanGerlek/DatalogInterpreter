...
CPPFILES = Scanner.cpp Parser.cpp DatalogProgram.cpp Relation.cpp DatalogDatabase.cpp DatalogInterpreter.cpp DependencyGraphBuilder.cpp Graph.cpp RuleEvaluator.cpp DepthFirstSearcher.cpp
PROJECT = project5
